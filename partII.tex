...
This project is the Master's thesis of G.~Almondo. The main result are orientational probability distributions for triaxial ellipsoids in simple shear flow, subject to rotational diffusion. Under my supervision he derived a new Langevin equation for quaternions representing rotations. He verified the new equation both against previous analytical results \cite{rallison1978,haber1984} and his own microscopic numerical simulations.
...
% Concretely for our problem with a rotating particle in a simple shear, we assume that
% \begin{align}
%     \frac{\Reys|\ve u' \nabla \ve u^\infty|}{|\nabla^2 \ve u'|} \ll 1\,,
% \end{align}
% and this leads to the Stokes solution which behaves like $\ve u' \sim 1/r^2\,, r \to \infty$. But inserting this into our assumption gives
% \begin{align}
%     \frac{\Reys/r^2}{1/r^4} = \Reys r^2 \ll 1\,.
% \end{align}
% So at $r \approx 1/\sqrt{\Reys}$ the Stokes solution becomes invalid.
