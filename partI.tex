...
The technical centerpiece of this thesis is the calculation of an effective equation of motion, starting from the fundamental equations. The effective equations describe the rotation of a spheroid which is small, but finite. The motion of a finite particle is affected by inertia, but also the motion of the surrounding fluid is, which in turn modifies the forces and torques acting on the particle. These effects are captured in our calculation. It is described in detail in [] and Paper []. In the remainder of this thesis we will discuss more carefully the \emph{why} and \emph{how} of these equations.
