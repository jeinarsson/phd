...
You are now reading Part I, which continues in \Secref{motivation} with the grander motives for our research.

In \Secref{background} I attempt to introduce our research to a reader without a strong technical background. Perhaps the reader is a new student, or a curious uncle of mine. But I hope that also an experienced reader may enjoy the text; do we share the same mental imagery of physics, you and me? How would you explain?
...
. We compute many long trajectories with different initial conditions, and plot the resulting surfaces-of-section. Four examples for $\lambda=5$ and increasing values of $\kappa$ are shown in Figs.~\ref{fig:poincare1o00}-\ref{fig:poincare2o00}.
