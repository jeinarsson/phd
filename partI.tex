...
The point $(0,0)$ on the surface-of-section is an elliptic fixed point. As explained in \Secref{jefftriaxial} the dynamical system \eqnref{np} is reversible, and consequently the dynamics around the fixed point is described by a one-parameter family of closed orbits \cite{lamb1998}.
