...
\obs{Part III contain technical appendices. But right now there aren't any, so this sentence and Part III must be removed.}

\obs{Part IV} contain the published papers A-G.
