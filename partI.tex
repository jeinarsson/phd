...
\end{align}
The vector $\ve \Omega=\ve \omega_f/2$ is a common quantity in our calculations, and therefore is given its own symbol. For example, the angular velocity of a sphere in a simple shear flow is exactly $\ve \Omega$. This is explained in detail in \Secref{jefferyequation}.
