...
% User commands
\title{Orientational dynamics of non-spherical particles \\ at small particle Reynolds numbers}
...
\includepdf[pages=-,width=\paperwidth,pagecommand={\thispagestyle{fb}}]{papers/F.pdf}
...
\includepdf[pages=2-,width=\paperwidth,pagecommand={\thispagestyle{fb}}]{papers/G.pdf}
